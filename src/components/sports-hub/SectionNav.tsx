...
import { Home, Newspaper, GraduationCap, Users, Trophy, BookOpen, Library, Star } from 'lucide-react';
          ...
          {sections.map((section) => {
            ...
            return (
              <Link
                ...
                href={section.href}
                className={cn(
                  'flex items-center gap-2 px-4 py-2.5 rounded-xl transition-all shrink-0 text-xs font-black uppercase tracking-widest whitespace-nowrap',
                  isActive
