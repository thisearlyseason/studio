...
export const DEMO_PLANS: Record<string, DemoPlan> = {
  ...
  school_demo: { planType: 'school', teamLimit: 10, role: 'admin', position: 'Athletic Director', teamVariants: ['Jr Soccer Club', 'Sr Soccer Club', 'Badminton Club', 'Jr Volleyball Club', 'Sr Volleyball Club'], isPro: true },
  school: { planType: 'school', teamLimit: 10, role: 'admin', position: 'Athletic Director', teamVariants: ['Jr Soccer Club', 'Sr Soccer Club', 'Badminton Club', 'Jr Volleyball Club', 'Sr Volleyball Club'], isPro: true },
