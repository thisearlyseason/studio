...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:9002/login and confirm the login form is present.
        ...
        # -> Navigate to http://localhost:9002/leagues to reach the Leagues area and then open the Division Architect tab.
